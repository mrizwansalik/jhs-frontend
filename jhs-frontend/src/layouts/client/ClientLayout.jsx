                                ...
                                <div className="offcanvas-lg offcanvas-start" id="sidebarAccount">
                                    ...
                                    <div className="offcanvas-body">
                                        ...
                                        <nav className="nav flex-column pb-1 pb-lg-3 mb-2">
                                            ...
                                            {checkFeaturePermission('articleratinglist-view') ? <Link to='/system/articleRatingList' className={`nav-link fw-semibold py-2 px-0 ${location.pathname === '/system/articleRatingList' ? 'active' : ''}`}><i className="ai-list fs-5 opacity-60 me-2" />Article Rating List</Link> : ''}

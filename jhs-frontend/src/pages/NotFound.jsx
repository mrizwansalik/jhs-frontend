      ...
      <main className="page-wrapper">
        ...
        <div className="container d-flex flex-column justify-content-center min-vh-100 py-5">
          ...
          <div className="text-center pt-4 mt-lg-2">
            ...
            <p className="fs-lg pb-2 pb-md-0 mb-4 mb-md-5">The page you are looking for was moved, removed or might never existed.</p> <Link className="btn btn-lg btn-primary" to='/'>Go to homepage</Link>
          </div>
        </div>
      </main>
    </>

...
const RevisionDiscussion = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.articleRevision_data_id?.discussion ?? '');
    ...
    useEffect(() => {
        setEditorData(articleInfo?.articleRevision_data_id?.discussion ?? '')
    }, [articleInfo?.articleRevision_data_id?.discussion])
...
export default RevisionDiscussion;
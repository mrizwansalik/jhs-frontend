...
import { addArticleRevisionTable, updateArticleRevisionTable } from 'store/main/articlesRevision/actions';
import { useDispatch } from 'react-redux';

const RevisionTableModel = ({ tableEditId, articleId, editor, tableData, setTableEditId, tableLength = 0 }) => {
...
export default RevisionTableModel;
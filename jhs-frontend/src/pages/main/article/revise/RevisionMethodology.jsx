...
const RevisionMethodology = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.articleRevision_data_id?.methodology ?? '');
    ...
    useEffect(() => {
        setEditorData(articleInfo?.articleRevision_data_id?.methodology ?? '')
    }, [articleInfo?.articleRevision_data_id?.methodology])
...
export default RevisionMethodology;
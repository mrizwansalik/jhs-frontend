...
const RevisionSupplementary = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.articleRevision_data_id?.supplementary ?? '');

    useEffect(() => {
        setEditorData(articleInfo?.articleRevision_data_id?.supplementary ?? '')
    }, [articleInfo?.articleRevision_data_id?.supplementary])
...
export default RevisionSupplementary;
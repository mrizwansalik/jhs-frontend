...
const RevisionCategory = () => {
    ...
    const updateArticleRevisionHandle = (formData) => {
        dispatch(
        ...
        navigate(`/main/article/${articleId}/revision/abstract`);
    }
    ...
    return (
        ...
        <section className="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4 mb-4">
            <div className="card-body">
                <form onSubmit={handleSubmit(updateArticleRevisionHandle)}>
...
export default RevisionCategory;
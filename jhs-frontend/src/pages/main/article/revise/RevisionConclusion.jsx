...
const RevisionConclusion = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.articleRevision_data_id?.conclusion ?? '');

    useEffect(() => {
        setEditorData(articleInfo?.articleRevision_data_id?.conclusion ?? '')
    }, [articleInfo?.articleRevision_data_id?.conclusion])
...
export default RevisionConclusion;
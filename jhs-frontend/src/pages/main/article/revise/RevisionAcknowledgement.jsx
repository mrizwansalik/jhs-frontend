...
const RevisionAcknowledgement = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.articleRevision_data_id?.acknowledgement ?? '');

    useEffect(() => {
        setEditorData(articleInfo?.articleRevision_data_id?.acknowledgement ?? '')
    }, [articleInfo?.articleRevision_data_id?.acknowledgement])
...
export default RevisionAcknowledgement;
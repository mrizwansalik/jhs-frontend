...
const RevisionIntroduction = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.articleRevision_data_id?.introduction ?? '');

    useEffect(() => {
        setEditorData(articleInfo?.articleRevision_data_id?.introduction ?? '')
    }, [articleInfo?.articleRevision_data_id?.introduction])
...
export default RevisionIntroduction;
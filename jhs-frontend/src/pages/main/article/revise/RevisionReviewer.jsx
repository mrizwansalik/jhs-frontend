...
const RevisionReviewers = () => {
    ...
    const updateDraftArticleHandle = (formData) => {
        ...
        dispatch(updateArticleRevision({ body: { suggestedReviewerList: data }, options: { id: articleId, btnLoader: true, __module: 'articleRevision', showToast: true } }));
...
export default RevisionReviewers;
...
import { deleteArticleRevisionFigure, deleteArticleRevisionTable, updateArticleRevision } from 'store/main/articlesRevision/actions';
...
const RevisionResult = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.articleRevision_data_id?.result ?? '');
    ...
    useEffect(() => {
        setEditorData(articleInfo?.articleRevision_data_id?.result ?? '')
    }, [articleInfo?.articleRevision_data_id?.result])
    ...
    useEffect(() => {
        window.addEventListener("journalArticleRevisionDelete", (e) => {
            dispatch(deleteArticleRevisionTable({
                body: { articleTableID: e.detail.tableId },
                options: { id: articleId, btnLoader: true, __module: 'articleRevision', showToast: true },
                editor
            }))
        }, false);
        window.addEventListener("journalArticleRevisionDeleteFigure", (e) => {
            dispatch(deleteArticleRevisionFigure({

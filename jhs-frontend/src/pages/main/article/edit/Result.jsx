...
const Result = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.article_data_id?.result ?? '');
    ...
    useEffect(() => {
        setEditorData(articleInfo?.article_data_id?.result ?? '')
    }, [articleInfo?.article_data_id?.result])

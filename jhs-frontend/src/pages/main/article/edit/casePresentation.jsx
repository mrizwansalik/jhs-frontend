...
const CasePresentation = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.article_data_id?.case_presentation ?? '');
    ...
    useEffect(() => {
        setEditorData(articleInfo?.article_data_id?.case_presentation ?? '')
    }, [articleInfo?.article_data_id?.case_presentation])

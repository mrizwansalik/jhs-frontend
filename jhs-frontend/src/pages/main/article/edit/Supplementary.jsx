...
const Supplementary = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.article_data_id?.supplementary ?? '');

    useEffect(() => {
        setEditorData(articleInfo?.article_data_id?.supplementary ?? '')
    }, [articleInfo?.article_data_id?.supplementary])

...
const Disclosure = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.article_data_id?.disclosure ?? '');

    useEffect(() => {
        setEditorData(articleInfo?.article_data_id?.disclosure ?? '')
    }, [articleInfo?.article_data_id?.disclosure])

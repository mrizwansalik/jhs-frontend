...
const Conclusion = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.article_data_id?.conclusion ?? '');

    useEffect(() => {
        setEditorData(articleInfo?.article_data_id?.conclusion ?? '')
    }, [articleInfo?.article_data_id?.conclusion])

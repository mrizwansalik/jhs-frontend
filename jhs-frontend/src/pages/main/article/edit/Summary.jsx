                                        ...
                                        ((articleErrors?.warningMessages?.length != 0 || articleErrors?.referencesWarningMessages?.length != 0) && articleErrors.length != 0) ?
                                            <>
                                                {
                                                    ...
                                                    articleErrors?.warningMessages?.map((item, index) => {
                                                        return (
                                                            <div className="alert alert-danger" key={`warningMessages${index}`} role="alert">

                                                                <h4 className="h5 alert-heading text-capitalize"><i className="ai-circle-slash fs-xl pe-1 me-2" />{item.type}:</h4>
                                                                <p>{item.message} </p>
                                                                <Link to={`/main/article/${articleId}/edit/${item.goto}`} className="alert-link text-capitalize"> Go To {item.goto} Page</Link>
                                                            </div>
                                                        );
                                                    })
                                                }
                                                {
                                                    (articleErrors?.referencesWarningMessages?.length != 0) ?
                                                        <div className="alert alert-danger mb-0" role="alert">
                                                            ...
                                                            <Link to={`/main/article/${articleId}/edit/reference`} className="alert-link text-capitalize"> Go To Article Reference Page</Link>
                                            ...
                                            : (
                                                <div className="card-body">
                                                    ...
                                                    <Link className="btn btn-primary ms-3" to={`/main/article/${articleId}/edit/submit`}>Move to submit</Link>
                                                </div>
                                            )
                                    }
                                </div>

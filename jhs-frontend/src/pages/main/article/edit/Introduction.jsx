...
const Introduction = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.article_data_id?.introduction ?? '');

    useEffect(() => {
        setEditorData(articleInfo?.article_data_id?.introduction ?? '')
    }, [articleInfo?.article_data_id?.introduction])

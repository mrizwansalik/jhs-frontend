...
const Discussion = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.article_data_id?.discussion ?? '');
    ...
    useEffect(() => {
        setEditorData(articleInfo?.article_data_id?.discussion ?? '')
    }, [articleInfo?.article_data_id?.discussion])

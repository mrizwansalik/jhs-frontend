...
const Acknowledgement = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.article_data_id?.acknowledgement ?? '');

    useEffect(() => {
        setEditorData(articleInfo?.article_data_id?.acknowledgement ?? '')
    }, [articleInfo?.article_data_id?.acknowledgement])

...
const ArticleRevisionTableCardView = ({ id, data, setTableEditId, editor, tableLength = 0 }) => {
  ...
  const handleDelete = () => {
    const event = new CustomEvent("journalArticleRevisionDelete", {
      detail: { tableId: id },
    });
...
export default ArticleRevisionTableCardView;

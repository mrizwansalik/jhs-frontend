...
const ArticleRevisionFigureCardView = ({ id, data, setFigureEditId, editor, figureLength = 0 }) => {
  ...
  const handleDelete = () => {
    const event = new CustomEvent("journalArticleRevisionDeleteFigure", {
      detail: { figureId: id },
    });
...
export default ArticleRevisionFigureCardView;

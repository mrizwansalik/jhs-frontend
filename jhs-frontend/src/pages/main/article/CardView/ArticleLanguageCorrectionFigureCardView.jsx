...
const ArticleLanguageCorrectionFigureCardView = ({ id, data, setFigureEditId, editor, figureLength = 0 }) => {
  ...
  const handleDelete = () => {
    const event = new CustomEvent("journalArticleLanguageCorrectionDeleteFigure", {
      detail: { figureId: id },
    });
...
export default ArticleLanguageCorrectionFigureCardView;

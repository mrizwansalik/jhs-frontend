...
const ArticleLanguageCorrectionTableCardView = ({ id, data, setTableEditId, editor, tableLength = 0 }) => {
  ...
  const handleDelete = () => {
    const event = new CustomEvent("journalArticleLanguageCorrectionDelete", {
      detail: { tableId: id },
    });
...
export default ArticleLanguageCorrectionTableCardView;

...
import { updateRevisionReference } from 'store/main/articlesRevisionReference/actions';

const UpdateRevisionReferenceModel = ({ articleId }) => {

        const dispatch = useDispatch();
        const [reference, setReference] = useState('');
        const selectedReference = useSelector((state) => state.articleRevision.selectedReference);
...
export default UpdateRevisionReferenceModel;
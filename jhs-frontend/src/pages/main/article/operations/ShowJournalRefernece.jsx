                ...
                <div className="pt-3 pt-sm-0 ps-sm-3">
                    ...
                    <div className="text-muted fw-small d-flex flex-wrap flex-sm-nowrap align-items-center">
                        <div className="d-flex align-items-center text-nowrap ml-3">
                            <i className="ai-file ml-2 me-1" />
                            <span className="fw-bold">Volume:{' '}</span>{reference?.volume}
                        </div>
                        <div className="d-flex align-items-center text-nowrap ml-3">
                            <i className="ai-file ml-2 me-1" />
                            <span className="fw-bold">Issue :{' '}</span>{reference?.issue}
                        </div>
                        <div className="d-flex align-items-center text-nowrap ml-2">
                            <i className="ai-file me-1" />
                            <span className="fw-bold">Pages:{' '}</span>{reference?.pages}
                        </div>
                    </div>
                </div>
            </div>

...
import { updateLanguageCorrectionReferenceSorting, getSpecificLanguageCorrectionReference, removeLanguageCorrectionReference, addLanguageCorrectionReference, generateLanguageCorrectionReference } from '../../../../store/main/articlesLanguageCorrectionReference/actions';
...
import UpdateLanguageCorrectionReferenceModel from '../operations/UpdateLanguageCorrectionReferenceModel';
...
const LanguageCorrectionReference = () => {
    ...
    useEffect(() => {
        reset();
        const arr = [];
        if (articleInfo?.articleLanguageCorrection_data_id?.reference?.length) {
            articleInfo.articleLanguageCorrection_data_id.reference.map((item) => {
    ...
    const updateReferenceSortingHandle = () => {
        const data = items;
        dispatch(
            updateLanguageCorrectionReferenceSorting({
                body: { reference: data },
                options: { id: articleId, btnLoader: true, __module: 'articleLanguageCorrection', showToast: true },
            }));
            
        navigate(`/main/article/${articleId}/languageCorrection/summary`);
    }

    const updateReferenceHandler = (referenceId) => {
        dispatch(
            getSpecificLanguageCorrectionReference({
                options: { id: articleId, referenceId: referenceId, btnLoader: true, __module: 'articleLanguageCorrection', showToast: false },
            }));
    ...
    const removeReferenceFromArticle = (referenceId) => {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                dispatch(
                    removeLanguageCorrectionReference({
    ...
    const addReferenceHandle = (formData) => {
        ...
        dispatch(
            addLanguageCorrectionReference({
                body: { reference: { ...data } },
                options: { id: articleId, btnLoader: true, __module: 'articleLanguageCorrection', showToast: true },
            }));
    }
    ...
    const generateReferenceHandle = (formData) => {
        dispatch(
            generateLanguageCorrectionReference({
    ...
    return (
        <>
            ...
            <UpdateLanguageCorrectionReferenceModel
                articleId={articleId}
            />
        </>
    );
...
export default LanguageCorrectionReference;
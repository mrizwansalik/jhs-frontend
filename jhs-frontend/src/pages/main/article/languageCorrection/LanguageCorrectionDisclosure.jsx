...
const LanguageCorrectionDisclosure = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.articleLanguageCorrection_data_id?.disclosure ?? '');

    useEffect(() => {
        setEditorData(articleInfo?.articleLanguageCorrection_data_id?.disclosure ?? '')
    }, [articleInfo?.articleLanguageCorrection_data_id?.disclosure])
...
export default LanguageCorrectionDisclosure;
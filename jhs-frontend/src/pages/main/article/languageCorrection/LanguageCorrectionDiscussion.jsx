...
import { deleteArticleFigure, deleteArticleTable } from '../../../../store/main/articles/actions'
...
const LanguageCorrectionDiscussion = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.articleLanguageCorrection_data_id?.discussion ?? '');
    ...
    useEffect(() => {
        setEditorData(articleInfo?.articleLanguageCorrection_data_id?.discussion ?? '')
    }, [articleInfo?.articleLanguageCorrection_data_id?.discussion])
    ...
    useEffect(() => {
        if (articleInfo && selectedArticleType) {
            let tableArr = []
            let figureArr = []
            let pageIndex = selectedArticleType?.elements.indexOf("discussion");
                                    ...
                                    <div className="col-sm-12">
                                        <div className="text-center text-lg-start ">
                                            ...
                                            <div className="pb-3">
                                                ...
                                                />}
                                                <div className="invalid-feedback">{errors.discussion?.message}</div>
                                            </div>
                                        </div>
                                    </div>
...
export default LanguageCorrectionDiscussion;
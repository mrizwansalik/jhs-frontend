...
const LanguageCorrectionAbstract = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.articleLanguageCorrection_data_id?.abstract ?? '');
    ...
    const updateDraftArticleHandle = (formData) => {
        ...
        navigate(`/main/article/${articleId}/languageCorrection/keyword`);
    }
...
export default LanguageCorrectionAbstract;
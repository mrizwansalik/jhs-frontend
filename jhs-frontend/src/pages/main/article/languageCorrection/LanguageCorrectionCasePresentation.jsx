...
const LanguageCorrectionCasePresentation = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.articleLanguageCorrection_data_id?.case_presentation ?? '');
    ...
    useEffect(() => {
        setEditorData(articleInfo?.articleLanguageCorrection_data_id?.case_presentation ?? '')
    }, [articleInfo?.articleLanguageCorrection_data_id?.case_presentation])
...
export default LanguageCorrectionCasePresentation;
...
const LanguageCorrectionMethodology = () => {
    ...
    const [editorData, setEditorData] = useState(articleInfo?.articleLanguageCorrection_data_id?.methodology ?? '');
    ...
    useEffect(() => {
        setEditorData(articleInfo?.articleLanguageCorrection_data_id?.methodology ?? '')
    }, [articleInfo?.articleLanguageCorrection_data_id?.methodology])
...
export default LanguageCorrectionMethodology;
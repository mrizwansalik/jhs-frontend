...
import { exportCitation } from 'store/main/publishedArticles/actions';
        ...
        const getCitationHandler = (formData) => {
                dispatch(
                        exportCitation({
                                ...
                                options: { id: articleId, btnLoader: true, __module: 'home', showToast: true },
                        }));
        }

        return (
                <Modal id={`showPublishedArticleCitationModel`}>
                                ...
                                <div className="card-body">
                                        {
                                                <form className='mb-4' onSubmit={handleSubmit(getCitationHandler)}>
                                                        ...
                                                        <p className="fs-sm text-muted mb-0">{articleInfo?.doi}</p>

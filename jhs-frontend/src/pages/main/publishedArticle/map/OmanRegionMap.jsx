...
import am5geodata_omanLow from "@amcharts/amcharts5-geodata/omanLow";
...
const OmanRegionMap = () => {
  ...
  const regionData = useSelector((state) => state.home.singleArticleOmanRegionMetrics);

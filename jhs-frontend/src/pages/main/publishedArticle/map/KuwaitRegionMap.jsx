...
import am5geodata_kuwaitLow from "@amcharts/amcharts5-geodata/kuwaitLow";
import { useSelector } from "react-redux";

import styles from '../Style/Chart.module.css'; // Import the CSS module

const KuwaitRegionMap = () => {
  const chartRef = useRef(null);
  const regionData = useSelector((state) => state.home.singleArticleKuwaitRegionMetrics);
...
export default KuwaitRegionMap;

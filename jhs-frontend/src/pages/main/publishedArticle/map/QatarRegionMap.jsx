...
import am5geodata_qatarLow from "@amcharts/amcharts5-geodata/qatarLow";
import { useSelector } from "react-redux";

import styles from '../Style/Chart.module.css'; // Import the CSS module

const QatarRegionMap = () => {
  const chartRef = useRef(null);
  const regionData = useSelector((state) => state.home.singleArticleQatarRegionMetrics);

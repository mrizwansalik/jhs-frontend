...
const ViewSingleAuthorReview = () => {
  ...
  return (
    <>
         {
            author?.userReport?.articles?.completed_reviewed_list && author?.userReport?.articles?.completed_reviewed_list?.map((article) => {
               return (
...
export default ViewSingleAuthorReview;

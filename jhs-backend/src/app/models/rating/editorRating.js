...
const editorRatingSchema = new Schema(
    {
...
const EditorRating = mongoose.model("editorRating", editorRatingSchema);

// validator for updating and rating
const editorRatingValidate = (rating) => {
...
module.exports = { EditorRating, editorRatingValidate };
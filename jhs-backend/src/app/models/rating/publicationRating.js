...
const publicationRatingSchema = new Schema(
    {
        article_id: {
...
const PublicationRating = mongoose.model(
    "publicationRating",
    publicationRatingSchema
);

// validator for updating and rating
const publicationRatingValidate = (rating) => {
...
module.exports = { PublicationRating, publicationRatingValidate };

...
exports.getUserCompany = catchAsync(async (req, res) => {
    ...
    const company = await Company.find({ _owner: req.params.userId });
...
exports.getUserJournal = catchAsync(async (req, res) => {

    const journal = await Journal.find({ _manageBy: req.params.userId });
